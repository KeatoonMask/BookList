...
class MockBookService: BookService {
    ...
    private var books: [Book] = [
        Book(id: 0, title: "The Fellowship of the Ring", author: "J. R. R. Tolkien", price: 18.85, imageName: "fellowship"),
        Book(id: 1, title: "The Lord of the Rings: The Two Towers", author: "J. R. R. Tolkien", price: 18.85, imageName: "fellowship"),
        Book(id: 2, title: "Homo Deus: A Brief History of Tomorrow", author: "Yuval Noah Harari", price: 18.85, imageName: "fellowship"),
        Book(id: 3, title: "The 4-Hour Workweek", author: "Timothy Ferriss", price: 18.85, imageName: "fellowship"),
        Book(id: 4, title: "Man's Search for Meaning", author: "Viktor E. Frankl", price: 18.85, imageName: "fellowship"),
        Book(id: 5, title: "The Odyssey", author: "Homer", price: 18.85, imageName: "fellowship"),
        Book(id: 6, title: "Artificial Intelligence: A Modern Approach", author: "Stuart J. Rossell", price: 18.85, imageName: "fellowship"),
        Book(id: 7, title: "Creativity, Inc.", author: "Ed Catmull", price: 18.85, imageName: "fellowship")
    ]

    private var booksDetail: [BookDetail] = [
        BookDetail(id: "1", bookId: 0, author: "J. R. R. Tolkien", title: "The Fellowship of the Ring", price: 18.85, genre: [Genre.fantasy, Genre.action], kind: "Novel",description: "The Fellowship of the Ring is the first of three volumes in The Lord of the Rings, an epic set in the fictional world of Middle-earth. The Lord of the Rings is an entity named Sauron, the Dark Lord, who long ago lost the One Ring that contains much of his power. His overriding desire is to reclaim the Ring and use it to enslave all of Middle-earth.", imageName: "fellowship", isAvailable: false)
    ]
